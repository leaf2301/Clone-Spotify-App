...
class SearchResultsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    private let tableView: UITableView = {
        ...
        tableView.register(SearchResultDefaultTableViewCell.self, forCellReuseIdentifier: "SearchResultDefaultTableViewCell")
        tableView.register(SearchResultSubtitleTableViewCell.self, forCellReuseIdentifier: "SearchResultSubtitleTableViewCell")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .artist(model: let model):
            guard let cell = tableView.dequeueReusableCell(withIdentifier: "SearchResultDefaultTableViewCell", for: indexPath) as? SearchResultDefaultTableViewCell else { fatalError() }
        ...
        case .album(model: let model):
            guard let cell = tableView.dequeueReusableCell(withIdentifier: "SearchResultSubtitleTableViewCell", for: indexPath) as? SearchResultSubtitleTableViewCell else { fatalError() }
